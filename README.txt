...
Dependent functions - to run this program, there are required subfunctions that allow the proper read and structuring of the data.

Loading files: stateLetter2NumberConverter, Nlx2MatCSC, ts, tsd, replay_LoadSpikes
Hilbert for theta: InstSig_theta, InstSig
Phase statistics: circstat toolbox specifically - circ_mean;circ_rtest;circ_r
